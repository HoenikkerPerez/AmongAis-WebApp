class DsController {
    ...
    _loadWsMessages() {
        ...
        document.addEventListener("DS_MYGLOBALSTATISTICS", this._myGlobalStatisticsReceiver.bind(this), false);

        document.addEventListener("DS_HISTORY", this._historyReceiver.bind(this), false);
        document.addEventListener("DS_MYHISTORY", this._myHistoryReceiver.bind(this), false);
    }
    ...
    _myGlobalStatisticsReceiver(evt) {
    }
